...
import {
  getDataVaultContract,
  getWeb3Provider,
} from "../helper/DataVaultSmartContract";
import { Web3Provider } from "@ethersproject/providers";
import { useAtom } from "jotai";
import {
  web3ConnectionAtom,
  web3ConnectionInterface,
} from "../atoms/web3Connection";
...
export default function ConnectWallet() {
  ...
  return (
    <div className=" rounded-lg border-2 border-primary-vermilion">
      <Button
        color={isNetworkWrong ? "red" : "customWhite"}
        className={
          isNetworkWrong
            ? ""
            : "text-base text-white hover:bg-hash-dark hover:text-primary-vermilion"
        }
        onClick={isNetworkWrong ? changeWrongNetwork : connectToWallet}
      >
        {isNetworkWrong
          ? "Change Network"
